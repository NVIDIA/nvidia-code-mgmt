 ...
 * recovery status and DOT blob requirements. Returns JSON array of device entries.
 * 
 ...
 * @return true on success (including no devices), false on critical USB init failure
 * 
