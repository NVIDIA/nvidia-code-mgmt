...
class MCTPVdmHelper : public mctp_vdm::MctpDiscoveryHandlerIntf
{
  public:
    ...
    mctp_vdm::requester::Coroutine queryBootStatus(uint8_t eid, const mctp_vdm::Message*& responseMsg,
            size_t& responseLen);
    mctp_vdm::requester::Coroutine queryBootStatusImpl(uint8_t eid, const mctp_vdm::Message*& responseMsg,
            size_t& responseLen);
