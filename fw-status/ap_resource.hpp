...
constexpr static int maxBootCompleteTimeout = maxBootCompleteTimeoutPerAttempt * numberOfSlots * maxAttemptsPerSlot;
/**@class APResource
 *
    ...
    private:
       ...
       std::string apMCTPService{};
        ...
        bool checkForEnabledApEid() const noexcept
        {
            ...
            auto ret = dbusUtil.getProperty<bool>(apMCTPService.c_str(), objPath.c_str(),
        ...
        /**@brief Checks whether the AP FW is healthy based on the associated MCTP EID object
         *
        ...
        /**@brief Checks whether the EC FW is healthy based on the ERoT MCTP EID object
         *
         ...
         * Starts a timer for of duration max bootcomplete timeout if AP is found to be in recovery
         *
         * @return coroutine
         *
         */
        ...
        /**@brief Checks whether the AP FW is in recovery based on QueryBootStatus output
         * and/or MCTP EID object
         *
