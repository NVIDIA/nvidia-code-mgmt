...
class GPIOResource : public BaseResource
{
  ...
  private:
     ...
     * appear (interfacesAdded) to detect the ERoT coming back, and use a periodic
     * timer to re-trigger MCTP discovery. No-op in interrupt mode.
     */
    ...
    /** @brief Whether an MCTP endpoint with this resource's EID exists on D-Bus.
     */
