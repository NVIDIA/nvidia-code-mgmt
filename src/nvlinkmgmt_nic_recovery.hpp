  ...
  public:
    NVLinkManagementNICRecoveryUpdater(sdbusplus::bus_t& bus) :
        BaseItemUpdater(bus, NVLINKMANAGEMENTNIC_RECOVERY_SUPPORTED_MODEL,
                        ...
                        NVLINKMANAGEMENTNIC_RECOVERY_BUSNAME_UPDATER,
                        NVLINKMANAGEMENTNIC_RECOVERY_UPDATE_SERVICE, false,
                        NVLINKMANAGEMENTNIC_RECOVERY_BUSNAME_INVENTORY)
    {}
    ...
    std::vector<std::string> getItemUpdaterInventoryPaths() override
    {
        ...
        std::string invPath = std::string(SOFTWARE_OBJPATH) + "/" +
                              NVLINKMANAGEMENTNIC_RECOVERY_NAME;
    ...
    {
        return NVLINKMANAGEMENTNIC_RECOVERY_TIMEOUT;
    }
     ...
     *
     * @return false - for nvlink management nic recovery inventory check is not
     * required
     */
